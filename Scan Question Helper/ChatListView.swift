                ...
                .background(
                    Capsule()
                        .stroke(LinearGradient(
                            colors: [.yellow.opacity(0.5), .pink.opacity(0.5)],
                            startPoint: .leading,
                            endPoint: .trailing
                        ), lineWidth: 1)
                )
                ...
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        HStack(alignment: .bottom, spacing: 8) {
                            ...
                            MessageBubble(message: "Hi there! 👋", isBot: true)
                        }
                        ...
                        HStack(spacing: 8) {
                            ...
                            MessageBubble(message: "Tap a task you need help with or ask anything in a new chat.", isBot: true)
                        }
                    }
                    .padding(.horizontal)
